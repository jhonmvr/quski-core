...
public class RiesgoAcumuladoByIdNegociacionSpec extends AbstractSpecification<TbQoRiesgoAcumulado> {
	private Long idNegociacion;

	public RiesgoAcumuladoByIdNegociacionSpec(Long idNegociacion) {
