...
public class CatalogoResponseActividadWrapper implements Serializable{
	...
	private List<CatalogoActividadWrapper> catalogo;
	...
	public List<CatalogoActividadWrapper> getCatalogo() {
		return catalogo;
	}
	public void setCatalogo(List<CatalogoActividadWrapper> catalogo) {
