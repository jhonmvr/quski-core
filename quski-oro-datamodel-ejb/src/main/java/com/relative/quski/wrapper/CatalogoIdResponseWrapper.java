...
public class CatalogoIdResponseWrapper implements Serializable{
	...
	private List<CatalogoIdWrapper> catalogo;
	...
	public List<CatalogoIdWrapper> getCatalogo() {
		return catalogo;
	}
	public void setCatalogo(List<CatalogoIdWrapper> catalogo) {
