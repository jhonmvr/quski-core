...
public class CatalogoResponseWrapper implements Serializable{
	...
	private List<CatalogoWrapper> catalogo;
	...
	public List<CatalogoWrapper> getCatalogo() {
		return catalogo;
	}
	public void setCatalogo(List<CatalogoWrapper> catalogo) {
