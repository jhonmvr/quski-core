...
public class CatalogoResponseAgenciaWrapper implements Serializable{
	...
	private List<CatalogoAgenciaWrapper> catalogo;
	...
	public List<CatalogoAgenciaWrapper> getCatalogo() {
		return catalogo;
	}
	public void setCatalogo(List<CatalogoAgenciaWrapper> catalogo) {
