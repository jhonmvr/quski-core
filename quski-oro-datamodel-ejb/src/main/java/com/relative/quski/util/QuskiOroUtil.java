	...
	public static StringBuilder CalculadoraToStringXml( CalculadoraEntradaWrapper wrapper ) throws RelativeException {
		...
		wrapper.getGarantias().forEach(e ->{
			...
			garantiaBuider.append(	"							<Garantia>\n" + 
								"								<TipoJoya>" + e.getTipoJoya() + "</TipoJoya>\n" + 
								"								<Descripcion>" + e.getDescripcion() + "</Descripcion>\n" + 
								"								<EstadoJoya>" + e.getEstadoJoya() + "</EstadoJoya>\n" + 
								"								<TipoOroKilataje>" + e.getTipoOroKilataje() + "</TipoOroKilataje>\n" + 
								"								<PesoGr>" + e.getPesoGr() + "</PesoGr>\n" + 
								"								<TienePiedras>" + e.getTienePiedras() + "</TienePiedras>\n" + 
								"								<DetallePiedras>" + e.getDetallePiedras() + "</DetallePiedras>\n" + 
								"								<DescuentoPesoPiedras>" + e.getDescuentoPesoPiedras() + "</DescuentoPesoPiedras>\n" + 
								"								<PesoNeto>" + e.getPesoNeto() + "</PesoNeto>\n" + 
								"								<PrecioOro>" + e.getPrecioOro() + "</PrecioOro>\n" + 
								"								<ValorAplicableCredito>" + e.getValorAplicableCredito() + "</ValorAplicableCredito>\n" + 
								"								<ValorRealizacion>" + e.getValorRealizacion() + "</ValorRealizacion>\n" + 
								"								<NumeroPiezas>" + e.getNumeroPiezas() + "</NumeroPiezas>\n" + 
								"								<DescuentoSuelda>" + e.getDescuentoSuelda() + "</DescuentoSuelda>\n" + 
								"							</Garantia>\n");
		...
		xml.append("<soap:Envelope\n" + 
				...
				"					<XmlParametrosRiesgo>\n" + 
				"						<ParametrosRiesgo>\n" + 
				"				              <PerfilRiesgo>"+ wrapper.getParametroRiesgo().getPerfilRiesgo() + "</PerfilRiesgo>\n" + 
				"				              <OrigenOperacion>"+ wrapper.getParametroRiesgo().getOrigenOperacion() + "</OrigenOperacion>\n" + 
				"				              <RiesgoTotal>"+ wrapper.getParametroRiesgo().getRiesgoTotal() + "</RiesgoTotal>\n" + 
				"				              <FechaNacimiento>"+ wrapper.getParametroRiesgo().getFechaNacimiento() + "</FechaNacimiento>\n" + 
				"				              <PerfilPreferencia>" + wrapper.getParametroRiesgo().getPerfilPreferencia() + "</PerfilPreferencia>\n" + 
				"				              <AgenciaOriginacion>" + wrapper.getParametroRiesgo().getAgenciaOriginacion() + "</AgenciaOriginacion>\n" + 
				"				              <IdentificacionCliente>" + wrapper.getParametroRiesgo().getIdentificacionCliente() + "</IdentificacionCliente>\n" + 
				"				              <CalificacionMupi>" + wrapper.getParametroRiesgo().getCalificacionMupi() + "</CalificacionMupi>\n" + 
				"				              <CoberturaExcepcionada>" + wrapper.getParametroRiesgo().getCoberturaExcepcionada() + "</CoberturaExcepcionada>\n" + 
				"				            </ParametrosRiesgo>\n" + 
				"					</XmlParametrosRiesgo>\n" + 
				"					<XmlGarantias>\n" + 
				"						<Garantias>\n" + 
