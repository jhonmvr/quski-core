...
public class LocalStorageClient {
	...
	public static void main(String[] args) {
		...
		/*	Class<? extends ArrayList> listType = new ArrayList<HerederoWrapper>().getClass();
			...
			ObjectEncriptedWrapper wrapper = new ObjectEncriptedWrapper();
			wrapper.setObjectEncripted("");
			//LocalStorageClient.createObjectBig(urlService, databaseName, collectionName, wrapper, null);
	...
	public static RespuestaObjectWrapper createObjectBig(String urlService,String databaseName, String collectionName,NodoWrapper wrapper,
		...
		try {
			Gson gson = new Gson();
//	String encodedUrl = Base64.getUrlEncoder().encodeToString(wrapper.getObjectEncripted().getBytes());
			String jsonString = gson.toJson(wrapper);
			...
			e.printStackTrace();
			throw new RelativeException(Constantes.ERROR_CODE_CUSTOM,"ERROR AL LLAMAR SERVICIO DE createObjectBig:");
		} 
	}
	...
	public static RespuestaObjectWrapper findMetadatosQuskiById(String urlService,String objectId)
			throws RelativeException {
	
		try {
			String service = urlService.concat("findMetadatosQuskiById?").
					concat("&id=").concat(objectId);
			log.info("===> callBpmsInitProcesss con servcio " + service);
			Map<String, Object> response = ReRestClient.callRestApi(RestClientWrapper.CONTENT_TYPE_JSON,
	...
	public static RespuestaObjectWrapper findAllMetadatosQuski(String urlService)
			throws RelativeException {
	
		try {
			String service = urlService.concat("findAllMetadatosQuski");
			log.info("===> callBpmsInitProcesss con servcio " + service);
			Map<String, Object> response = ReRestClient.callRestApi(RestClientWrapper.CONTENT_TYPE_JSON,
					RestClientWrapper.CONTENT_TYPE_JSON, null, null, RestClientWrapper.METHOD_GET, null, null,
					null, QuskiOroConstantes.BPMS_REST_TIMEOUT_DEFAULT,
